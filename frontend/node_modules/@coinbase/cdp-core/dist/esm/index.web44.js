import { fromNumber as E } from "./index.web99.js";
import { toHex as T, createWalletClient as P } from "viem";
import { getUserOperation as R, sendUserOperation as b, signEvmTypedData as U, signEvmHash as O, getCurrentUser as w, signOut as x, sendEvmTransaction as H, signEvmTransaction as D, signEvmMessage as N } from "./index.web6.js";
import "@coinbase/cdp-api-client";
import "./index.web16.js";
import { validateUserConnected as v, validateUserHasEvmSmartAccount as S, RPCRequestError as u, STANDARD_ERROR_CODES as o, validateIsUsingEOA as h, validateUserOwnsAddress as p, EIP1193ProviderError as g } from "./index.web17.js";
import "zustand";
import { userOperationChainIdToNameMapping as m, isChainIdSupportedForCDPUserOps as I, isChainIdSupportedForCDPSends as F, sendTransactionChainIdToNameMapping as j, userOperationNameToChainIdMapping as k } from "./index.web29.js";
function f(t) {
  return {
    to: t.to,
    data: t.data,
