...
function TranslationResult({ 
  ...
  console.log('🔍 Original value:', result?.original);
  console.log('🔍 Translated value:', result?.translated);
  console.log('🔍 OriginalLyrics value:', result?.originalLyrics);
